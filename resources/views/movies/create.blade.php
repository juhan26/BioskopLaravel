        ...
        <div class="bg-white p-6 rounded-lg shadow-lg">
            ...
            <form action="{{ route('movies.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="mb-4">
                    ...
                    <input type="file" name="poster_url" id="poster_url" class="mt-1 block ml-4 pr-5 w-full text-smx     text-gray-500 file:mr-4 file:py-2 file:px-4 file:rounded-md file:border-0 file:text-sm file:font-semibold file:bg-indigo-50 file:text-indigo-700 hover:file:bg-indigo-100" required>
                </div>
                <div class="mb-4">
