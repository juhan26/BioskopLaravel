...
@section('content')
    <section id="edit-movie" class="p-6 max-w-screen-lg mx-auto">
        <div class="bg-white border border-gray-200 rounded-lg shadow-lg dark:bg-gray-800 dark:border-gray-700 p-6">
            ...
            @if ($errors->any())
            <div class="flex items-center p-4 mb-4 text-sm text-sky-700 rounded-lg bg-red-50 dark:bg-gray-800 dark:text-sky-600" role="alert">
            ...
            <form action="{{ route('showtimes.update', $showtime->id) }}" method="POST">
                ...
                <div class="flex justify-end">
                    <button type="submit" class="px-4 py-2 bg-sky-700 text-white rounded-md shadow-sm hover:bg-sky-800 focus:outline-none focus:ring-2 focus:ring-sky-700 focus:ring-offset-2">
                        Update Showtime
                    </button>
                </div>
            </form>
