...
<section id="booking-details" class="p-6 max-w-screen-lg mx-auto">
    <div class="flex flex-col items-center justify-between bg-white border border-gray-200 rounded-lg shadow-lg w-full max-w-screen-lg mx-auto md:flex-row md:max-w-5xl dark:border-gray-700 dark:bg-gray-800">
            ...
            <div class="flex justify-between">
                <div class="flex flex-col">
                    <div class="flex items-start">
                        <img src="data:image/png;base64,{{ $qrCodeImage }}" alt="QR Code" class="w-36 h-36 mb-4">
                    </div>
                    <h5 class="mb-2 text-4xl font-bold tracking-tight text-gray-900 dark:text-white">
                        {{ $firstBooking->movie->title }}
                    </h5>
                    <div class="flex flex-wrap my-3">
                        <p class="mb-2 text-lg font-semibold text-gray-900 dark:text-gray-100">
                            <strong>Date & Showtime:</strong> {{ $showtimeDate }} {{ $firstBooking->dateshowtime->showtime->start_time }} - {{ $firstBooking->dateshowtime->showtime->end_time }}
                        </p>
                    </div>
