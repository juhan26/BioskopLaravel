        ...
        <div id="flash-message" x-data="{ show: true }" x-init="setTimeout(() => show = false, 5000)" x-show="show"
            ...
            <form action="{{ route('dateshowtime.store') }}" method="POST">
                ...
                <div class="flex justify-end">
                    <button type="submit" class="px-4 py-2 bg-sky-700 text-white rounded-md shadow-sm hover:bg-sky-800 focus:outline-none focus:ring-2 focus:ring-sky-700 focus:ring-offset-2">Create Date & Showtimes</button>
                </div>
            </form>
        </div>
    </section>
