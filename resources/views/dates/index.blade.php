...
<div class="container mx-auto px-4">
    <h2 class="text-2xl font-semibold text-gray-800 dark:text-gray-200 mb-4 mt-4">Date</h2>
    <a href="{{ url('/date/create') }}" class="px-4 py-2 bg-primary-500 text-white rounded-md shadow-sm hover:bg-primary-600 focus:outline-none focus:ring-2 focus:ring-primary-500 focus:ring-offset-2">Add Dates</a>
    <div class="relative overflow-x-auto shadow-md sm:rounded-lg " style="margin-top: 2rem">
        <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
            ...
            <tbody>
                ...
                @empty
                <tr>
                    <td colspan="4" class="px-6 py-4 text-center text-gray-500 dark:text-gray-400">No Dates Found.</td>
                </tr>
                @endforelse
            </tbody>
        </table>
